...
\usepackage[
    ...
    top=1.0 cm,         % Top margin - adjust to increase/decrease top spacing
...
\begin{document}
    ...
    \begin{header}
        \fontsize{25 pt}{25 pt}\selectfont Tushar Singh  % CHANGE: Your full name here
    ...
    \section{Technologies}
        ...
        \begin{onecolentry}
        \textbf{Programming Languages:} JavaScript, Java, C++, Python, SQL  % CHANGE: Add your languages
        \end{onecolentry}
        ...
        \begin{onecolentry}
        \textbf{Databases:} MySQL, MongoDB, Redis \  % CHANGE: Add your database experience
        \end{onecolentry}
